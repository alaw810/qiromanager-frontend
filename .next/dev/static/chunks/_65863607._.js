...
function ProfilePage() {
    _s();
    const { user, token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSave = async ()=>{
        ...
        try {
            setSaving(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$axios$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosClient"].put(`/api/v1/users/${user.id}`, {
                fullName,
                email,
                username
            });
...
_s(ProfilePage, "jM3Xe3pwjbJgUcvIUSoolpC8RpQ=", false, function() {
    return [
...
//# sourceMappingURL=_65863607._.js.map